from lando.common.commands import WorkflowNames, WorkflowTypes
...
class TestWorkflowNamess(TestCase):
    ...
    @patch('lando.common.commands.ZippedWorkflowNames')
    ...
    @patch('lando.common.commands.PackedWorkflowNames')
